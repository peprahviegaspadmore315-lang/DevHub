...
import com.learningplatform.security.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/courses/*/enrolled").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/enrollments/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/execute").authenticated()
